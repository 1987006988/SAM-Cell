...
CONFIG="${CONFIG:-$PROJECT_ROOT/configs/sam_cell_multi_expert_cellpose_gate_workstation2.yaml}"
...
OUT_DIR="${OUT_DIR:-$PROJECT_ROOT/outputs/samcell_optimization_20260503_watershed_repair/proposal_oracle}"
