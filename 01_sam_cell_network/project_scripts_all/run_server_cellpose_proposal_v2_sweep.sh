...
CONFIG="${CONFIG:-$PROJECT_ROOT/configs/sam_cell_multi_expert_cellpose_gate_adaptive_selector_workstation2.yaml}"
...
OUT_DIR="${OUT_DIR:-$PROJECT_ROOT/outputs/samcell_optimization_20260503_cellpose_v2/sweep_proposal_v2_cellpose50}"
...
echo "source=$SOURCE worst_k=$WORST_K"
date
...
"$PYTHON" scripts/sweep_cellpose_proposal_v2.py \
  --config "$CONFIG" \
